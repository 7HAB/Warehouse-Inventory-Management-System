...
namespace DA_Project
{
    public partial class CustomerForm : Form
    {
        ...
        public void RefreshListView()
        {
            ...
            {
                string[] WRow = { c.Customer_ID.ToString(), c.Customer_Name, c.Customer_Mobile.ToString(), c.Customer_Phone.ToString(), c.Customer_Fax.ToString(), c.Customer_Email };
            ...
            if (textBox1.Text != string.Empty && textBox2.Text != string.Empty && textBox3.Text != string.Empty && textBox4.Text != string.Empty && textBox5.Text != string.Empty && textBox6.Text != string.Empty)
            {
                try
                {
                    ...
                    if (c == null)
                    {
                        ...
                        customer.Customer_Mobile = int.Parse(textBox3.Text);
                        customer.Customer_Phone = int.Parse(textBox4.Text);
                        customer.Customer_Fax = int.Parse(textBox5.Text);
                        customer.Customer_Email = textBox6.Text;
            ...
            else
            {
                try
                {
                    ...
                    if (c != null)
                    {
                        ...
                        {
                            c.Customer_Mobile = int.Parse(textBox3.Text);

                        }

                        if (textBox4.Text != string.Empty)
                        {
                            c.Customer_Phone = int.Parse(textBox4.Text);
                        }

                        if (textBox5.Text != string.Empty)
                        {
                            c.Customer_Fax = int.Parse(textBox5.Text);
                        }

                        if (textBox6.Text != string.Empty)
                        {
                            c.Customer_Email = textBox6.Text;
                        }
