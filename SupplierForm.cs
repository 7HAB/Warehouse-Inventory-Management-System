...
namespace DA_Project
{
    public partial class SupplierForm : Form
    {
        ...
        public void RefreshListView()
        {
            ...
            {
                string[] WRow = { s.Supplier_ID.ToString(), s.Supplier_Name, s.Mobile.ToString(), s.Phone.ToString(), s.Fax.ToString(), s.Email, s.website };
                ...
                try
                {
                    ...
                    if (s == null)
                    {
                       ...
                       // supplier.Supplier_ID = int.Parse(textBox1.Text);
                        ...
                        supplier.Phone = int.Parse(textBox4.Text);
                        supplier.Fax = int.Parse(textBox5.Text);
                        supplier.Email = textBox6.Text;
            ...
            else
            {
                try
                {
                    ...
                    if (s != null)
                    {
                        ...
                        {
                            s.Mobile = int.Parse(textBox3.Text);

                        }

                        if (textBox4.Text != string.Empty)
                        {
                            s.Phone = int.Parse(textBox4.Text);
                        }

                        if (textBox5.Text != string.Empty)
                        {
                            s.Fax = int.Parse(textBox5.Text);
                        }
